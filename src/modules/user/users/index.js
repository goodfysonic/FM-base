...
const UserListPage = ({ pageOptions }) => {
    ...
    const columns = [
        ...
        { title: translate.formatMessage(commonMessage.birthDate), dataIndex: ['birthDate'],
            render: (birthDate) => {
                const result = convertUtcToLocalTime(birthDate, DEFAULT_FORMAT, DATE_FORMAT_VALUE);
                return <div>{result}</div>;
            },
        },  
        { title: translate.formatMessage(commonMessage.address), dataIndex: ['address'] },
